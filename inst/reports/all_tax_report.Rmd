...
```{r grid-build, warning=FALSE, message=FALSE}
...
The grid (is shown) show the proportion of threatened species.

```{r leaflet, fig.show='asis', echo=FALSE, results='asis'}
...
# Distribution of Extent of occurrences values
